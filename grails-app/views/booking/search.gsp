...
<!-- main-section -->
  ...
  <input id="city">
												...
												<g:select name="startLocation" id="category1" from="${com.jtechies.Location.list() }" optionKey="id" optionValue="cityName" noSelection="['':'Please Select one...']"/>
										...
										<div class="agileinfo_main_grid">
											<div class="agileits_w3layouts_grid">
												<h5>To*</h5>
												<g:select name="endLocation" id="category1" from="${com.jtechies.Location.list() }" optionKey="id" optionValue="cityName" noSelection="['':'Please Select one...']"/>
												<!-- <select id="category1" name="category1" required="">
													<option value="category2">Singapore</option>
													<option value="category1">Australia</option>
													<option value="category3">America</option>
...
<!-- //bootstrap-modal-pop-up --> 
 <script>
  $( function() {
    var availableTags = ${com.jtechies.Location.list().collect{it.cityName };
    $( "#tags" ).autocomplete({
   ...
   <g:javascript>
            $(document).ready(function() {
               $('#city').autocomplete({
                 source: '<g:createLink controller='Location' action='ajaxCityFinder'/>'
               }); 
