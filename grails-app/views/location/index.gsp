		...
		<div id="list-location" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="cityName" title="${message(code: 'location.cityName.label', default: 'City Name')}" />
				...
				<g:each in="${locationInstanceList}" status="i" var="locationInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${locationInstance.id}">${fieldValue(bean: locationInstance, field: "cityName")}</g:link></td>
