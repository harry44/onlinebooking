	...
	<body>
		...
		<div id="show-location" class="content scaffold-show" role="main">
			...
			<ol class="property-list location">
				...
				<g:if test="${locationInstance?.cityName}">
				<li class="fieldcontain">
					<span id="cityName-label" class="property-label"><g:message code="location.cityName.label" default="City Name" /></span>
					
						<span class="property-value" aria-labelledby="cityName-label"><g:fieldValue bean="${locationInstance}" field="cityName"/></span>
